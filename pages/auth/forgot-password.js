      ...
      <div style={s.card}>
        ...
        {sent ? (
          <>
            ...
            <p style={s.sub}>We sent a password reset link to <strong>{email}</strong>. It expires in 1 hour.</p>
            <div style={s.noteBox}>Didn't receive it? Check your spam folder or <button style={s.retryBtn} onClick={() => setSent(false)}>try again</button>.</div>
